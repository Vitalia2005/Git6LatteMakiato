...
class Ui_addEditForm(object):
    def setupUi(self, addEditForm):
        ...
        self.ground_or_grains_box = QtWidgets.QLineEdit(addEditForm)
    ...
    def retranslateUi(self, addEditForm):
        ...
        self.label.setText(_translate("addEditForm", "ID(оставьте 0, чтобы добавить)"))
